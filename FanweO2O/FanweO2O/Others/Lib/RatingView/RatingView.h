...
-(void)ratingChanged2:(NSInteger)tag newRating:(float)newRating;
@end
...
-(void)setImagesDeselected:(NSString *)unselectedImage partlySelected:(NSString *)partlySelectedImage 
			  fullSelected:(NSString *)fullSelectedImage canTouch:(BOOL)cantouch andDelegate:(id<RatingViewDelegate>)d;
