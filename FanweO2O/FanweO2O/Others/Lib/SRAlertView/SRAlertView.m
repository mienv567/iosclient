...
- (FXBlurView *)blurView {
    ...
    if (!_blurView) {
        ...
        _blurView.tintColor = [UIColor colorWithRed:0.000 green:0.000 blue:0.000 alpha:1.00];
...
- (UIView *)coverView {
    ...
    if (!_coverView) {
        [self insertSubview:({
            ...
            _coverView.backgroundColor = [UIColor colorWithRed:0.580 green:0.584 blue:0.584 alpha:1];//[UIColor colorWithWhite:0 alpha:0.5];
...
- (void)setupAlertView {
    ...
    if (_rightActionTitle) {
        [_alertView addSubview:({
            ...
            [_rightAction setTitleColor:RGB(255, 34, 68) forState:UIControlStateNormal];
